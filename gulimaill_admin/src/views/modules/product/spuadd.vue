    ...
    <div>
        <el-row>
                ...
                <el-card class="box-card" style="width:80%;margin:20px auto">
                    ...
                    >
                        ...
                        <el-form-item label="设置积分" prop="bounds">
                            <label style="margin: 0 15px; padding-right: 15px;"
                                >金币</label
                            >
                            <el-input-number
                                style="width:130px"
                        ...
                        <el-form-item label="商品介绍" prop="decript1">
                            <multi-upload v-model="spu.decript"></multi-upload>
                        </el-form-item>

                        <el-form-item label="商品图集" prop="images1">
                            ...
                            <el-form ref="form" :model="spu">
                                ...
                                >
                                    ...
                                    >
                                        <el-option
                                            v-for="(val,
                                            vidx) in attr.valueSelect.split(
                                                ';'
                                            )"
                                            :key="vidx"
                                            :label="val"
                        ...
                        <div slot="header" class="clearfix">
                            ...
                            <el-form ref="saleform" :model="spu">
                                ...
                                >
                                    <el-input
                                        v-model="
                                            dataResp.tempSaleAttrs[aidx].attrId
                                        "
                                        type="hidden"
                                        v-show="false"
                                    ></el-input>
                                    <el-checkbox-group
                                        v-model="
                                            dataResp.tempSaleAttrs[aidx]
                                                .attrValues
                                        "
                                    >
                                        <el-checkbox
                                            v-if="
                                                dataResp.saleAttrs[aidx]
                                                    .valueSelect != ''
                                            "
                                            :label="val"
                    ...
                    <el-table :data="spu.skus" style="width: 100%">
                        <el-table-column label="属性组合">
                            <el-table-column
                                :label="item.attrName"
                                v-for="(item,
                                index) in dataResp.tableAttrColumn"
                                :key="item.attrId"
                            >
            ...
            <el-col :span="24" v-show="step == 4">
                <el-card class="box-card" style="width:80%;margin:20px auto">
                    <h1>保存成功</h1>
                    <el-button type="primary" @click="addAgian"
                        >继续添加</el-button
                    >
                </el-card>
            </el-col>
    ...
    methods: {
        ...
        generateSkus() {
            ...
            descartes.forEach((descar, descaridx) => {
                ...
                if (this.dataResp.memberLevels.length > 0) {
                    for (
                        let i = 0;
                        i < this.dataResp.memberLevels.length;
                        i++
                    ) {
                        if (
                            this.dataResp.memberLevels[i]
        ...
        getShowSaleAttr() {
            ...
            if (!this.dataResp.steped[1]) {
                this.$http
                    .get(`/product/attr/sale/list/${this.spu.catalogId}`, {
                        params: {
                            page: 1,
                            limit: 500
                        }
        ...
        showBaseAttrs() {
            if (!this.dataResp.steped[0]) {
                this.$http
                    .get(`/product/attrgroup/${this.spu.catalogId}/withattr`)
                    .then(({ data }) => {
                        //先对表单的baseAttrs进行初始化
