    ...
    >
      ...
      <template v-if="dataForm.type === 1">
        <el-form-item size="mini">
          <a href="https://s.qiniu.com/7Rfaym" target="_blank"
            >免费申请(七牛)10GB储存空间</a
          >
        </el-form-item>
      ...
      <template v-else-if="dataForm.type === 2">
        <el-form-item size="mini">
          <a
            href="https://www.aliyun.com/minisite/goods?userCode=y93lfwbg"
            target="_blank"
            >免费领取阿里云优惠券</a
          >
        </el-form-item>
      ...
      <template v-else-if="dataForm.type === 3">
        <el-form-item size="mini">
          <a href="https://curl.qcloud.com/zt3xdYbZ" target="_blank"
            >免费领取腾讯云优惠券</a
          >
        </el-form-item>
