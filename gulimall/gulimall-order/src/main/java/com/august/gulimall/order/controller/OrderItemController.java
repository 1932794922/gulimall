...
import com.august.gulimall.order.excel.OrderItemExcel;
...
public class OrderItemController {
    ...
    public Result<PageData<OrderItemDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params){
    ...
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        ...
        ExcelUtils.exportExcelToTarget(response, null, list, OrderItemExcel.class);
    }
