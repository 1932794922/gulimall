...
import com.august.gulimall.coupon.excel.SkuBoundsExcel;
...
public class SkuBoundsController {
    ...
    //@RequiresPermissions("coupon:skubounds:page")
    public Result<PageData<SkuBoundsDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params){
        PageData<SkuBoundsDTO> page = skuBoundsService.page(params);

        return new Result<PageData<SkuBoundsDTO>>().ok(page);
    }

    @GetMapping("{id}")
    @ApiOperation("信息")
    //@RequiresPermissions("coupon:skubounds:info")
    public Result<SkuBoundsDTO> get(@PathVariable("id") Long id){
        SkuBoundsDTO data = skuBoundsService.get(id);

        return new Result<SkuBoundsDTO>().ok(data);
    }
    ...
    public Result save(@RequestBody SkuBoundsDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);

        skuBoundsService.save(dto);
    ...
    public Result update(@RequestBody SkuBoundsDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        skuBoundsService.update(dto);
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    //@RequiresPermissions("coupon:skubounds:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SkuBoundsDTO> list = skuBoundsService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, list, SkuBoundsExcel.class);
    }
